...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        System.out.println(requestCode + " " + Startseite_Fragment.NEW_STUHL_ACTIVITY_REQUEST_CODE);

        System.out.println(resultCode + " " + Eintrag_Essen.RESULT_OK);
        System.out.println(requestCode + " " + Startseite_Fragment.NEW_ESSEN_ACTIVITY_REQUEST_CODE);
        ...
        if (resultCode == Eintrag_Essen.RESULT_OK && requestCode == Startseite_Fragment.NEW_ESSEN_ACTIVITY_REQUEST_CODE) {
